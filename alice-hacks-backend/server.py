...
ill a human being, so, uh, I can't, I can be wrong.""", filler_indices=[(44, 2), (132, 2), (251, 2), (370, 2), (0, 2), (59, 2), (181, 2), (300, 2), (141, 2), (260, 2), (95, 2), (136, 8),
 (255, 8)], filler_count=13, wpm=167.4359457422758, words=['Um', 'what', 'do', 'I', 'begin', "Let's", 'start', 'with', 'this', 'Uh', r"I'm", 'sorry', 'Um', 'this', 'is', 'a', 'first', 'for', 'me', r"I've", 'never', 'faced', 'criticism', 'like', 'this', 'before', 'Uh', 'so', 'yeah', "I'm", 'surrounded', 'by',
'good', 'people', 'and', 'um', 'I', 'believe', 'I', 'make', 'good', 'decisions', 'but', "I'm", 'still', 'a', 'human', 'being', 'so', 'uh', 'so', 'yeah', "I'm", 'surrounded', 'by', 'good', 'people', 'and', 'um', 'I', 'believe', 'I', 'make', 'good', 'decisions', 'but', "I'm", 'still', 'a', 'human', 'being', 'so', 'uh', 'I', "can't", 'I', 'can', 'be', 'wrong'], sentence_length=[5, 4, 3, 7, 7, 53, 0], overall_score=random.random(), most_common_words=[('I', 7), ("I'm", 5), ('so', 4), ('good', 4), ('this', 3)], detailed_feedback=r"""1) Fluency:\n- Ther
...
usion for the listener.\n\nOverall, the speaker should work on reducing filler words and pauses, organizing their thoughts more coherently, and improving the clarity and grammar of their sentences for better overall fluency and logical structure.""",
                    ...
                    grammar_mistakes=0, full_combo=False, max_combo=100)
...
def home(input: FromFiles) -> Response:
    ...
    res = Response(
        ...
        max_combo=get_max_combo(filler_indices),
        full_combo=get_max_combo(filler_indices) == len(words)
    )
